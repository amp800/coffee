      ...
      <header className="sticky top-0 z-20 border-b border-stone-900/5 bg-[#f6f3ee]/85 backdrop-blur-md">
        <div className="mx-auto flex max-w-2xl items-center justify-between px-5 py-3.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-[17px] font-extrabold tracking-tight text-stone-900">Barista</h1>
          ...
          <div className="flex items-center gap-2">
            {activeCount > 0 && (
              <span className="animate-pulse-ring rounded-full bg-emerald-500 px-3 py-1 text-[12px] font-bold text-white">
                {activeCount}
              </span>
            )}
            {!empty && (
      ...
      <main className="mx-auto max-w-2xl px-5">
        ...
        {orders === null ? (
          <div className="grid place-items-center py-28">
            <div className="h-7 w-7 animate-spin rounded-full border-[3px] border-stone-200 border-t-emerald-600" />
          </div>
        ) : empty ? (
          ...
          <div className="py-8">
            <div className="rounded-3xl border-2 border-dashed border-stone-200 px-5 py-9 text-center">
              <div className="mx-auto w-28 opacity-90">
                <div dangerouslySetInnerHTML={{ __html: coffees[0].svg }} />
              </div>
              ...
              <p className="mx-auto mt-1 max-w-[300px] text-[13.5px] leading-relaxed text-stone-500">
                Tell everyone the address below - or point them at the QR code.
              </p>
          ...
          <>
            ...
            {renderGroup('On the machine', 'bg-sky-400', making)}
